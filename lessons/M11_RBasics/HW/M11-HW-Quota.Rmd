...
---
# Computing Payoff for a Quota Structure
...
The salesperson would like to know how much she would earn if she reaches a given percentage of quarterly quota.
...
2) qplot() makes a fairly nice plot quickly. See [the docs here](https://ggplot2.tidyverse.org/reference/qplot.html).
